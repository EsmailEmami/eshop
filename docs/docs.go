...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/productItem/selectList/{productId}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/parameter.ListResponse-models_DiscountUserOutPutModel"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "models.DiscountUserOutPutModel": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "parameter.ListResponse-models_DiscountUserOutPutModel": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.DiscountUserOutPutModel"
                    }
                },
                "from": {
                    "type": "integer"
